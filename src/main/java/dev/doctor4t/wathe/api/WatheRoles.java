...
public class WatheRoles {
    ...
    public static final Role CIVILIAN = registerRole(new Role(Wathe.id("civilian"), 0x36E51B, true, false, Role.MoodType.REAL, GameConstants.getInTicks(0, 14), false), Faction.CIVILIAN);
    public static final Role VIGILANTE = registerRole(new Role(Wathe.id("vigilante"), 0x1B8AE5, true, false, Role.MoodType.REAL, GameConstants.getInTicks(0, 18), false), Faction.VIGILANTE);
